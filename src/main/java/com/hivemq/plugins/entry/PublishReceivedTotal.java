 ...
 * @author Lukas Brandl
 */
public class PublishReceivedTotal extends AbstractMetricEntry implements SYSTopicEntry {

    @Inject
    protected PublishReceivedTotal(BlockingMetricService metricService) {
        super(metricService);
    }
    ...
    public String description() {
        return "The total number of PUBLISH messages received since the broker started.";
    }
