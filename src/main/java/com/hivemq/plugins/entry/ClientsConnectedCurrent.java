 ...
 * @author Lukas Brandl
 */
public class ClientsConnectedCurrent extends AbstractMetricEntry implements SYSTopicEntry {

    @Inject
    public ClientsConnectedCurrent(final BlockingMetricService metricService) {
        super(metricService);
    }
