 ...
 * @author Lukas Brandl
 */
public class ClientsDisconnectedTotal extends AbstractMetricEntry implements SYSTopicEntry {

    @Inject
    public ClientsDisconnectedTotal(final BlockingMetricService metricService) {
        super(metricService);
    }

    @Override
    public String topic() {
        return "$SYS/broker/clients/disconnected";
    }
