 ...
 * @author Lukas Brandl
 */
public class BytesSentTotal extends AbstractMetricEntry implements SYSTopicEntry {

    @Inject
    public BytesSentTotal(final BlockingMetricService metricService) {
        super(metricService);
    }

    @Override
    public String topic() {
        return "$SYS/broker/load/bytes/sent";
    }
    ...
    public String description() {
        return "The total number of bytes sent since the broker started.";
    }
