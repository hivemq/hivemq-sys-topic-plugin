...
public class ConnectionsRate extends RateEntry {
    ...
    protected Meter meter() {
        return metricService.getHiveMQMetric(HiveMQMetrics.INCOMING_CONNECT_RATE);
    }

    @Override
    public String topic() {
        return "$SYS/broker/load/connections/";
    }
    ...
    public String description() {
        return "The moving average of the number of CONNECT packets received by the broker over different time intervals." +
                " The final \"+\" of the hierarchy can be 1min, 5min or 15min." +
                " The value returned represents the number of connections received in 1 minute," +
