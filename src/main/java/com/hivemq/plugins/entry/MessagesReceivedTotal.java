 ...
 * @author Lukas Brandl
 */
public class MessagesReceivedTotal extends AbstractMetricEntry implements SYSTopicEntry {

    @Inject
    protected MessagesReceivedTotal(BlockingMetricService metricService) {
        super(metricService);
    }

    @Override
    public String topic() {
        return "$SYS/broker/messages/received";
    }
