 ...
 * @author Lukas Brandl
 */
public class MessagesSentRate extends RateEntry {

    @Inject
    protected MessagesSentRate(BlockingMetricService metricService) {
        super(metricService);
    }
    ...
    @Override
    public String topic() {
        return "$SYS/broker/load/messages/sent/";
    }
    ...
    public String description() {
        return "The moving average of the number of all types of MQTT messages sent by the broker over different time intervals." +
                " The final \"+\" of the hierarchy can be 1min, 5min or 15min." +
                " The value returned represents the number of messages send in 1 minute, averaged over 1, 5 or 15 minutes.";
    }
