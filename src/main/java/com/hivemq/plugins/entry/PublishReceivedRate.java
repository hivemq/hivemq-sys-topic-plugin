 ...
 * @author Lukas Brandl
 */
public class PublishReceivedRate extends RateEntry {

    @Inject
    protected PublishReceivedRate(BlockingMetricService metricService) {
        super(metricService);
    }
    ...
    @Override
    public String topic() {
        return "$SYS/broker/load/publish/received/";
    }
    ...
    public String description() {
        return "The moving average of the number of publish messages received by the broker over different time intervals." +
                " The final \"+\" of the hierarchy can be 1min, 5min or 15min." +
                " The value returned represents the number of publish messages received in 1 minute, averaged over 1, 5 or 15 minutes.";
    }
